  ...
  useEffect(() => {
    const fetchSharedResults = async () => {
      ...
      try {
        ...
        setAnalysisData(data.data.analysisData);
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4 animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Repository: <code className="code-font text-primary bg-primary/10 px-2 py-1 rounded text-sm">{repositoryUrl}</code>
            </p>
            
            {/* View count badge */}
            <div className="flex items-center justify-center gap-2 pt-2">
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-muted/20 border border-border text-muted-foreground text-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <p className="text-sm text-foreground">
                    <span className="font-semibold">Python {pythonVersion}</span> detected
                  </p>
                </div>
              </div>
            </div>
